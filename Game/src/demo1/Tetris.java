...
public void save() throws FileNotFoundException {
    ...
    String outputFileName1="score.txt";
    String outputFileName2="nowtype.txt";
    String outputFileName3="nexttype.txt";
    String outputFileName4="wall.txt";
    PrintWriter out1 =new PrintWriter(outputFileName1);
    out1.printf("%d ",GetScore());
    PrintWriter out2 =new PrintWriter(outputFileName2);
    out2.printf("%d ",currentOne.getType());
    PrintWriter out3 =new PrintWriter(outputFileName3);
    out3.printf("%d ",nextOne.getType());
